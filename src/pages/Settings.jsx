...
const Settings = () => {
  ...
  // Replace the handleThemeChange function with a simpler toggle handler
  const handleDarkModeToggle = (isDarkMode) => {
    // Set to 'dark' if toggle is on, 'light' if toggle is off
  ...
  // Add id property to each tab in tabsConfig
  const tabsConfig = [
    {
      id: 'general',
      label: 'General',
    ...
    },
    {
      ...
      content: (
        <div className="settings-section">
          ...
          <div 
            className="vat-status-box"
          >
            <h3 className="vat-status-heading">Current VAT Status:</h3>
  ...
  const activeTabContent = tabsConfig.find(tab => tab.id === activeTab)?.content;
  ...
  return (
    <PageLayout title="Settings">
      <div className="settings-header">
        ...
        {settingsCircuitBroken && (
          <div className="circuit-breaker-notification">
            <div>
