...
const PageLayout = ({ title, children, actions }) => {
  ...
  return (
    <div className="layout-container">
      {/* Mobile sidebar overlay (Only render when sidebar is open) */}
      {isSidebarOpen && (
        <div className="mobile-sidebar-overlay">
          ...
          <div
            ...
            style={{ 
              ...
              touchAction: 'manipulation' /* Enable proper touch handling */
            }}
          ></div>
          ...
          <div className="mobile-sidebar">
            <div className="sidebar-header">
              ...
              <button
                ...
                onClick={() => setIsSidebarOpen(false)}
                style={{ touchAction: 'manipulation' }} /* Enable proper touch handling */
              >
                <svg className="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
